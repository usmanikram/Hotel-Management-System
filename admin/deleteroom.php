...
<head>
    ...
    <title>Delete Room · Admin Panel · HMS</title>
...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
            ...
            <a href="../model/admin/room/delete.php?id=<?php echo $id; ?>" class="btn btn-sm btn-outline-secondary"><h2>Yes</h2></a>
            <a href="room.php" class="btn btn-sm btn-outline-secondary"><h2>No</h2></a>
