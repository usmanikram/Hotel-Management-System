...
<head>
    ...
    <title>Add Room Type · Admin Panel · HMS</title>
...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
            ...
            <form action="../model/admin/roomtype/add.php" method="post">
                <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="details" placeholder="Room Type Details">
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" class="form-control" name="price" placeholder="Room Type Price">
                        </div>
                    </div>
                </div>
                <div class="form-group">
