...
<head>
    ...
    <title>Add Service · Admin Panel · HMS</title>
...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
            ...
            <form action="../model/admin/service/add.php" method="post" >
                <div class="form-row">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" class="form-control" name="sprice" placeholder="Service Price">
                        </div>
                    </div>
                </div>
                <button type=submit" class="btn btn-sm btn-outline-secondary">Add Service</button>
            </form>
