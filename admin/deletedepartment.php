...
<head>
    ...
    <title>Department Delete · Admin Panel · HMS</title>
    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Delete Department</h1>
                <div class="btn-toolbar mb-2 mb-md-0">
                    <div class="btn-group mr-2">
                        <button onclick="location.href='adddepartment.php';" type="button" class="btn btn-sm btn-outline-secondary">Add New Department</button>
            ...
            <a href="../model/admin/department/delete.php?id=<?php echo $id; ?>" class="btn btn-sm btn-outline-secondary"><h2>Yes</h2></a>
            <a href="departments.php" class="btn btn-sm btn-outline-secondary"><h2>No</h2></a>
