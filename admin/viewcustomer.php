...
<head>
    ...
    <title>Customer · Admin Panel · HMS</title>
...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
            ...
            <form action="../model/admin/customer/update.php" method="post">
                <div class="form-row">
                ...
                <button type=submit" class="btn btn-sm btn-outline-secondary">Update Customer</button>
            </form>
